...
def go(config: DictConfig):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "basic_cleaning" in active_steps:
            mlflow.run(
                ...
                parameters={
                    ...
                    "output_artifact": config["cleaning"]["output_artifact"],
                    "output_type": config["cleaning"]["output_type"],
                    "output_description": config["cleaning"]["output_description"],
        ...
        if "train_random_forest" in active_steps:
            ...
            # step
            train_rf_path = os.path.join(os.path.dirname(__file__), "src/train_random_forest")
            _ = mlflow.run(
                train_rf_path,
                entry_point="main",
                parameters={
